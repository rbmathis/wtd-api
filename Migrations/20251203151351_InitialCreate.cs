        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowId = table.Column<int>(type: "integer", nullable: false),
                    CurrencyBalance = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBettingOpen = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prediction = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bets_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bets_Episodes_EpisodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bets_CharacterId",
                table: "Bets",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_Bets_EpisodeId_Status",
                table: "Bets",
                columns: new[] { "EpisodeId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Bets_UserId_EpisodeId",
                table: "Bets",
                columns: new[] { "UserId", "EpisodeId" });

            migrationBuilder.CreateIndex(
                name: "IX_Characters_ShowId_Status",
                table: "Characters",
